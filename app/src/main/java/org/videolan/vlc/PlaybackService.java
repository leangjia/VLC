...
import com.xuie.vlc.BuildConfig;
    ...
    private void showNotification() {
        ...
        try {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.mipmap.ic_stat_vlc)
            ...
            if (AndroidUtil.isJellyBeanOrLater()) {
                ...
                view.setImageViewBitmap(R.id.cover, cover == null ? BitmapFactory.decodeResource(getResources(), R.mipmap.icon) : cover);
                ...
                view_expanded.setImageViewBitmap(R.id.cover, cover == null ? BitmapFactory.decodeResource(getResources(), R.mipmap.icon) : cover);
                ...
                builder.setLargeIcon(cover == null ? BitmapFactory.decodeResource(getResources(), R.mipmap.icon) : cover)
